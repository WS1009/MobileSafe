...
import com.wangshun.ms.activity.EnterPsdActivity;
import com.wangshun.ms.db.dao.AppLockDao;
import com.wangshun.ms.utils.ForegroundAppUtils;
...
public class WatchDogService extends Service {
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(
                Uri.parse("content://applock/change"),
    ...
    private void watch() {
        ...
        new Thread() {
            public void run() {
                mPacknameList = mDao.findAll();
                for (int i = 0; i < mPacknameList.size(); i++) {
                    Log.i("mPacknameList", "PacknameList: " + mPacknameList.get(i));
                }
                ...
                while (isWatch) {
                    ...
                    String packagename= ForegroundAppUtils.getTopActivityName(getApplicationContext());
                    Log.i("packagename", "run: "+packagename);
                    ...
                    if (mPacknameList.contains(packagename)) {
                        ...
                        Log.i("mPacknameList.contains(packagename)", "run: "+mPacknameList.contains(packagename));
